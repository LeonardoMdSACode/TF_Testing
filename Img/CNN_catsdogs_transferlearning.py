...
print("Use TensorFlow Hub mobile for prediction")
...
print("Use TensorFlow Hub models")
print("Dataset")
...
print("Transfer learning with TensorFlow Hub")
...
print("Attach classification head")
print(".Sequential")
model = tf.keras.Sequential([
  feature_extractor,
  layers.Dense(2)
