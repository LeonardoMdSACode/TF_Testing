...
# Trying a simple RNN first
print("Simple RNN Forecasting")
...
# Retry the simple RNN but with early stopping and a validation set
print("Simple RNN but this time with early stopping and a validation set")
keras.backend.clear_session()
tf.random.set_seed(42)
np.random.seed(42)
...
mse_value = keras.metrics.mean_absolute_error(x_valid, rnn_forecast).numpy()
print(mse_value)

# Trying Sequence to Sequence RNN
print("Sequence-to-Sequence Forecasting")
